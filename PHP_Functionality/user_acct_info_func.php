<?php 
      ...
      if(isset($_POST['emp_number']))
      {
            ...
            $query_update = "UPDATE user_account_tbl SET username= '$username', user_password= '$password', confirm_password= '$con_password',
            user_type='$user_type', user_status='$user_status' WHERE emp_num='$emp_num';";

            $query_insert = "INSERT INTO user_account_tbl(user_id,employee_id,username,user_password,user_type,user_status,confirm_password,emp_num) 
            values ('','','$username','$password','$user_type','$user_status','$con_password',$emp_num)";
